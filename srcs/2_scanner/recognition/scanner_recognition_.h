...
t_error	lexer_rule_new_word(t_lexer *state);
t_error	lexer_rule_new_operator(t_lexer *state);
t_error	lexer_rule_in_middle_of_word(t_lexer *state);
t_error	lexer_rule_in_middle_of_operator(t_lexer *state);

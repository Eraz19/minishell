...
static void	parser_rules_init_case_item_1(t_rule *rules);
static void	parser_rules_init_case_item_2(t_rule *rules);
static void	parser_rules_init_case_item_3(t_rule *rules);
static void	parser_rules_init_case_item_4(t_rule *rules);
...
{
	parser_rules_init_case_item_1(rules);
	parser_rules_init_case_item_2(rules);
	parser_rules_init_case_item_3(rules);
	parser_rules_init_case_item_4(rules);
}

...
static void	parser_rules_init_cmd_suffix_1(t_rule *rules);
static void	parser_rules_init_cmd_suffix_2(t_rule *rules);
static void	parser_rules_init_cmd_suffix_3(t_rule *rules);
static void	parser_rules_init_cmd_suffix_4(t_rule *rules);
...
{
	parser_rules_init_cmd_suffix_1(rules);
	parser_rules_init_cmd_suffix_2(rules);
	parser_rules_init_cmd_suffix_3(rules);
	parser_rules_init_cmd_suffix_4(rules);
}

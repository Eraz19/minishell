...
static void	parser_rules_init_complete_command_1(t_rule *rules);
static void	parser_rules_init_complete_command_2(t_rule *rules);
...
{
	parser_rules_init_complete_command_1(rules);
	parser_rules_init_complete_command_2(rules);
}

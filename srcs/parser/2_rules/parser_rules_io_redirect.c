...
static void	parser_rules_init_io_redirect_1(t_rule *rules);
static void	parser_rules_init_io_redirect_2(t_rule *rules);
static void	parser_rules_init_io_redirect_3(t_rule *rules);
static void	parser_rules_init_io_redirect_4(t_rule *rules);
...
{
	parser_rules_init_io_redirect_1(rules);
	parser_rules_init_io_redirect_2(rules);
	parser_rules_init_io_redirect_3(rules);
	parser_rules_init_io_redirect_4(rules);
}

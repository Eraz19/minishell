...
static void	parser_rules_init_complete_commands_1(t_rule *rules);
static void	parser_rules_init_complete_commands_2(t_rule *rules);
...
{
	parser_rules_init_complete_commands_1(rules);
	parser_rules_init_complete_commands_2(rules);
}

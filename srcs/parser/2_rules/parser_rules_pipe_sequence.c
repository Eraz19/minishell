...
static void	parser_rules_init_pipe_sequence_1(t_rule *rules);
static void	parser_rules_init_pipe_sequence_2(t_rule *rules);
...
{
	parser_rules_init_pipe_sequence_1(rules);
	parser_rules_init_pipe_sequence_2(rules);
}

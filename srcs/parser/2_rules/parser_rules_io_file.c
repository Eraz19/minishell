...
static void	parser_rules_init_io_file_1(t_rule *rules);
static void	parser_rules_init_io_file_2(t_rule *rules);
static void	parser_rules_init_io_file_3(t_rule *rules);
static void	parser_rules_init_io_file_4(t_rule *rules);
...
{
	parser_rules_init_io_file_1(rules);
	parser_rules_init_io_file_2(rules);
	parser_rules_init_io_file_3(rules);
	parser_rules_init_io_file_4(rules);
}

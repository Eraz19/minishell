...
static void	parser_rules_init_command_1(t_rule *rules);
static void	parser_rules_init_command_2(t_rule *rules);
static void	parser_rules_init_command_3(t_rule *rules);
static void	parser_rules_init_command_4(t_rule *rules);
...
{
	parser_rules_init_command_1(rules);
	parser_rules_init_command_2(rules);
	parser_rules_init_command_3(rules);
	parser_rules_init_command_4(rules);
}

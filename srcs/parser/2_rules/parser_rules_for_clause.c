...
static void	parser_rules_init_for_clause_1(t_rule *rules);
static void	parser_rules_init_for_clause_2(t_rule *rules);
static void	parser_rules_init_for_clause_3(t_rule *rules);
static void	parser_rules_init_for_clause_4(t_rule *rules);
...
{
	parser_rules_init_for_clause_1(rules);
	parser_rules_init_for_clause_2(rules);
	parser_rules_init_for_clause_3(rules);
	parser_rules_init_for_clause_4(rules);
}

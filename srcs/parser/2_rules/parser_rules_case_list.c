...
static void	parser_rules_init_case_list_1(t_rule *rules);
static void	parser_rules_init_case_list_2(t_rule *rules);
...
{
	parser_rules_init_case_list_1(rules);
	parser_rules_init_case_list_2(rules);
}

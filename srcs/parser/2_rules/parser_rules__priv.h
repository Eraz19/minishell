#ifndef PARSER_RULES__PRIV_H
# define PARSER_RULES__PRIV_H

# include "parser.h"

void	parser_rules_init_and_or(t_rule *rules);
void	parser_rules_init_brace_group(t_rule *rules);
void	parser_rules_init_case_clause(t_rule *rules);
void	parser_rules_init_case_item(t_rule *rules);
void	parser_rules_init_case_item_ns(t_rule *rules);
void	parser_rules_init_case_list(t_rule *rules);
void	parser_rules_init_case_list_ns(t_rule *rules);
void	parser_rules_init_cmd_name(t_rule *rules);
void	parser_rules_init_cmd_prefix(t_rule *rules);
void	parser_rules_init_cmd_suffix(t_rule *rules);
void	parser_rules_init_cmd_word(t_rule *rules);
void	parser_rules_init_command(t_rule *rules);
void	parser_rules_init_complete_command(t_rule *rules);
void	parser_rules_init_complete_commands(t_rule *rules);
void	parser_rules_init_compound_command(t_rule *rules);
void	parser_rules_init_compound_list(t_rule *rules);
void	parser_rules_init_do_group(t_rule *rules);
...
void	parser_rules_init_for_clause(t_rule *rules);
void	parser_rules_init_function_body(t_rule *rules);
void	parser_rules_init_function_definition(t_rule *rules);
...
void	parser_rules_init_io_file(t_rule *rules);
void	parser_rules_init_io_here(t_rule *rules);
void	parser_rules_init_io_redirect(t_rule *rules);
...
void	parser_rules_init_pipe_sequence(t_rule *rules);
...
void	parser_rules_init_separator_op(t_rule *rules);
...
void	parser_rules_init_until_clause(t_rule *rules);
void	parser_rules_init_while_clause(t_rule *rules);
void	parser_rules_init_wordlist(t_rule *rules);

...
static void	parser_rules_init_separator_op_1(t_rule *rules);
static void	parser_rules_init_separator_op_2(t_rule *rules);
...
{
	parser_rules_init_separator_op_1(rules);
	parser_rules_init_separator_op_2(rules);
}

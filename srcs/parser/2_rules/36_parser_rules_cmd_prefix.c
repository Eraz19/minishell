...
static void	parser_rules_init_cmd_prefix_1(t_rule *rules);
static void	parser_rules_init_cmd_prefix_2(t_rule *rules);
static void	parser_rules_init_cmd_prefix_3(t_rule *rules);
static void	parser_rules_init_cmd_prefix_4(t_rule *rules);
...
{
	parser_rules_init_cmd_prefix_1(rules);
	parser_rules_init_cmd_prefix_2(rules);
	parser_rules_init_cmd_prefix_3(rules);
	parser_rules_init_cmd_prefix_4(rules);
}

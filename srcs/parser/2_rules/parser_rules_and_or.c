...
static void	parser_rules_init_and_or_1(t_rule *rules);
static void	parser_rules_init_and_or_2(t_rule *rules);
static void	parser_rules_init_and_or_3(t_rule *rules);
...
{
	parser_rules_init_and_or_1(rules);
	parser_rules_init_and_or_2(rules);
	parser_rules_init_and_or_3(rules);
}

...
static void	parser_rules_init_wordlist_1(t_rule *rules);
static void	parser_rules_init_wordlist_2(t_rule *rules);
...
{
	parser_rules_init_wordlist_1(rules);
	parser_rules_init_wordlist_2(rules);
}

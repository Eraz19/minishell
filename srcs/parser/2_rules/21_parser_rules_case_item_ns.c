...
static void	parser_rules_init_case_item_ns_1(t_rule *rules);
static void	parser_rules_init_case_item_ns_2(t_rule *rules);
...
{
	parser_rules_init_case_item_ns_1(rules);
	parser_rules_init_case_item_ns_2(rules);
}

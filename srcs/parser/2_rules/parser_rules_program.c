...
static void	parser_rules_init_program_1(t_rule *rules);
static void	parser_rules_init_program_2(t_rule *rules);
...
{
	parser_rules_init_program_1(rules);
	parser_rules_init_program_2(rules);
}

...
static void	rules_init_case_list_ns_1(t_rule *rules);
static void	rules_init_case_list_ns_2(t_rule *rules);
...
{
	rules_init_case_list_ns_1(rules);
	rules_init_case_list_ns_2(rules);
}

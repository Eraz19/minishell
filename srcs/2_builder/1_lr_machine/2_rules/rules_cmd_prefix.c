...
static void	rules_init_cmd_prefix_1(t_rule *rules);
static void	rules_init_cmd_prefix_2(t_rule *rules);
static void	rules_init_cmd_prefix_3(t_rule *rules);
static void	rules_init_cmd_prefix_4(t_rule *rules);
...
{
	rules_init_cmd_prefix_1(rules);
	rules_init_cmd_prefix_2(rules);
	rules_init_cmd_prefix_3(rules);
	rules_init_cmd_prefix_4(rules);
}

...
static void	rules_init_command_1(t_rule *rules);
static void	rules_init_command_2(t_rule *rules);
static void	rules_init_command_3(t_rule *rules);
static void	rules_init_command_4(t_rule *rules);
...
{
	rules_init_command_1(rules);
	rules_init_command_2(rules);
	rules_init_command_3(rules);
	rules_init_command_4(rules);
}

...
static void	rules_init_separator_1(t_rule *rules);
static void	rules_init_separator_2(t_rule *rules);
...
{
	rules_init_separator_1(rules);
	rules_init_separator_2(rules);
}

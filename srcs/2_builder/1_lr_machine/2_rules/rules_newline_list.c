...
static void	rules_init_newline_list_1(t_rule *rules);
static void	rules_init_newline_list_2(t_rule *rules);
...
{
	rules_init_newline_list_1(rules);
	rules_init_newline_list_2(rules);
}

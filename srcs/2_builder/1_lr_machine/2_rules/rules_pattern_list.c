...
static void	rules_init_pattern_list_1(t_rule *rules);
static void	rules_init_pattern_list_2(t_rule *rules);
static void	rules_init_pattern_list_3(t_rule *rules);
...
{
	rules_init_pattern_list_1(rules);
	rules_init_pattern_list_2(rules);
	rules_init_pattern_list_3(rules);
}

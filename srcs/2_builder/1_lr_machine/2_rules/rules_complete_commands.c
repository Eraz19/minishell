...
static void	rules_init_complete_commands_1(t_rule *rules);
static void	rules_init_complete_commands_2(t_rule *rules);
...
{
	rules_init_complete_commands_1(rules);
	rules_init_complete_commands_2(rules);
}

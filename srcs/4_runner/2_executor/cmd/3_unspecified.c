...
{
	return (str_cmp(cmd_name, "mapfile") == 0
...
{
	return (str_cmp(cmd_name, "complete") == 0
		...
		|| cmd_name_is_unspecified3(cmd_name));
}

bool	cmd_name_is_unspecified(const char *cmd_name)
{
	...
	{
		(void)undefined_behaviour("POSIX 2.9.1.4: If the command name matches "
			"the name of a utility listed in [...], "

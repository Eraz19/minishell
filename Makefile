...
SCANNER_SRCS=${SCANNER_DIR}/lexer/context/stack.c	\
	${SCANNER_DIR}/lexer/context/update.c			\
	${SCANNER_DIR}/lexer/context/update_.c			\
...
$(NAME): $(OBJS)
	@$(CC) $(CC_FLAGS) $(INCLUDES) -L$(LIB_DIR) $(OBJS) -lft $(LDFLAGS) -o $(NAME);

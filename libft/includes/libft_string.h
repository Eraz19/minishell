...
/*   Updated: 2026/03/31 14:13:34 by adouieb          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_dstr		str_cremove(t_cstr str, t_cstr remove_str);
t_dstr		str_dremove(t_dstr *str, t_cstr remove_str);
...
t_dstr_arr	str_split(t_cstr str, t_i8 c, t_bool (*rule)(t_cstr, t_i8, t_u32));

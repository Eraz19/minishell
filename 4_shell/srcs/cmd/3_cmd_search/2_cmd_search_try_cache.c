...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   2_cmd_search_try_cache.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: gastesan <gastesan@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/08/06 13:56:36 by gastesan          #+#    #+#             */
/*   Updated: 2026/08/06 13:56:37 by gastesan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
			...
			t_cmd_entry_point *out_entry_point)
{
	...
	if (err.type)
		return (err);
	found = false;
	err = file_check(cmd_path_from_cache->data, EXECUTABLE, &found);

 ...
 *  (@c compute_arith_expression) is a stub reporting @c ERR_INTERNAL
 *  (printed and requalified at production) until the arithmetic parser
 *  is implemented.
 */
 ...
 *          @c ERR_INTERNAL (printed and requalified at production)
 *          after the expression's own expansion.
 * @param expander Expander state (borrowed).
 * @return @c ERR_INTERNAL (printed); before evaluation: @c ERR_LIBC or
 *         any error of the nested expansion run.
 */

 ...
 *  the utility's POSIX exit status into @c status (0 on success,
 ...
 * @param status Set to the utility's POSIX exit status (borrowed).
 * @return @c ERR_NO or the requalified error (see each built-in).
 */
typedef t_error	(*t_builtin)(
					int argc,
					char **argv,
					char **envp,
					int *status);
...
// TODO: doc
typedef t_error	(*t_special_builtin)(
					int argc,
					char **argv,
					t_runner *runner,
					int *status);
...
t_error	builtin_break(int argc, char **argv, t_runner *runner, int *status);
 ...
 * @return @c ERR_NO.
 */
t_error	builtin_colon(int argc, char **argv, t_runner *runner, int *status);
 ...
 *
 * @p status n when given (modulo 256), else the last command's
 * status; 2 on an invalid @c n; @c ERR_INVALID_USAGE on too many
 * arguments.
 * @return @c ERR_VEOF (shell terminates with @c $?) / @c ERR_BUILTIN /
 *         @c ERR_INTERNAL.
 */
t_error	builtin_exit(int argc, char **argv, t_runner *runner, int *status);
 ...
 *
 * @p status @c ERR_INVALID_USAGE / @c ERR_ASSIGNMENT_MISSING_NAME
 ...
 *
 * @p status same set as @ref builtin_export.
 * @return @c ERR_NO / @c ERR_BUILTIN / @c ERR_INTERRUPTED /
 *         @c ERR_INTERNAL / @c ERR_LIBC.
 */
t_error	builtin_readonly(int argc, char **argv, t_runner *runner, int *status);
 ...
 *
 * @p status @c ERR_INVALID_USAGE / @c ERR_OPT_INVALID_ARG /
 ...
 *
 * @p status @c ERR_INVALID_USAGE / @c ERR_VAR_INVALID_NAME /
 ...
 */
t_error	builtin_unset(int argc, char **argv, t_runner *runner, int *status);
 ...
 *
 * @p status @c ERR_INVALID_USAGE / @c ERR_VAR_NOT_FOUND /
 ...
 * @c -nx, ...) is an operand.
 *
 * @p status @c ERR_POSIX_WRITE / @c ERR_INTERRUPTED / @c ERR_LIBC.
 * @return @c ERR_NO / @c ERR_BUILTIN / @c ERR_INTERRUPTED / @c ERR_LIBC.
 */
t_error	builtin_echo(int argc, char **argv, char **envp, int *status);
 ...
 *
 * @p status @c ERR_INVALID_USAGE / @c ERR_NOT_IMPLEMENTED (utility
 ...
 * unspecified-behaviour notice.
 *
 * @p status @c ERR_INVALID_USAGE / @c ERR_UB /
 * @c ERR_SHELL_NOT_FOUND / @c ERR_POSIX_WRITE / @c ERR_INTERRUPTED /
 * @c ERR_LIBC.
 * @return @c ERR_NO / @c ERR_BUILTIN / @c ERR_INTERRUPTED /
 *         @c ERR_INTERNAL / @c ERR_LIBC.
 */
t_error	builtin_pwd(int argc, char **argv, char **envp, int *status);
